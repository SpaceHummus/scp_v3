...
class CameraHandler:
    ...
    # file name - the image's file name
    # file_directory - defulat = "images/"
    # generate_file_name - If true, will add the camera's focus and ID to the file's name  
    # return full path saved file, file name
    def take_pic(self, file_name, flip_image=False, file_directory=IMAGES_DIR, generate_file_name=True):
    ...
    # generate_file_name - If true, will add the camera's focus and ID to the file's name  
    # return full path saved file, file name
    def take_pic_scp2(self, file_name):
        # Aquire image
        logging.info("taking picture, image name:%s",file_name)
